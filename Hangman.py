...
def get_user_guess(guess_list):
    ...
    while True:
        ...
        choice = input("Would you like to guess a letter or a word: ").lower()

        if choice == 'letter':

            while True:

                guess = input("Please enter your letter guess: ").upper()

                if (len(guess) == 1 and guess.isalpha()
                        and guess not in guess_list):

                    print("\n")
                    return guess

                elif (len(guess) == 1 and guess.isalpha()
                        and guess in guess_list):
            ...
            while True:
                ...
                guess = input("Please enter the word you"
                              "want to guess: ").upper()
            ...
            print("This is not a valid input."
                  "Please enter 'word' or 'letter'.")


def display(display_word, guess_list, guesses_left):

    print(f"{display_word}")
    print(f"Guesses left: {guesses_left}")
    print("Guesses: ", ", ".join(guess_list))
    print("\n")


def win_check(guess, word, guesses_left, game_on):
...
def modify_display_word(word, guess_list, display_word):

    display_word = [letter if letter in guess_list else "_" for letter in word]
...
def main():
    ...
    while playing:
        ...
        while game_on:
            ...
            display(display_word, guess_list, guesses_left)
            ...
            if len(guess) == 1:
                ...
                display_word = modify_display_word(word, guess_list,
                                                   display_word)

            game_on = win_check(guess, word, guesses_left, game_on)
